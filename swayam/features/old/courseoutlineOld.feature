@hybrid
Feature: Course Outline -Autograded Assessment and lesson 
  I want to testlesson and  Autograded Assessment creation as admin, verifying lesson content, taking assesssment and checking score as student
