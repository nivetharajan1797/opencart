@lessonVideoOnly @regression
Feature: To create lesson with Video only for a course
  To test Lesson having video only, and verifying lesson content as student.
