...
public class LoginSteps {
	...
	public void the_user_is_on_the_op_commerce_login_page() {
	...
	@When("the user enters valid credentials \\(user name: {string}, password: {string})")
	public void the_user_enters_valid_credentials_user_name_password(String email, String pwd) {
